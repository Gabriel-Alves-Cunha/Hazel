...
namespace Hazel
{
	...
	void SceneHierarchyPanel::DrawEntityNode(Entity entity)
	{
		...
		bool opened = ImGui::TreeNodeEx((void*)(ui64)(ui32)entity, flags, tag.c_str());
	...
	static void DrawVec3Control(const std::string& label, vec3& values, float resetValue = 0.0f, float columnWidth = 100.0f)
	{
		...
		ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4{ 0.2f, 0.7f, 0.2, 1.0f });
		// Y      /////////////////////////////////
		ImGui::PushFont(boldFont);
	...
	static void DrawComponent(const std::string& name, Entity entity, UIFunction uiFn)
	{
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity)
	{
		if (entity.HasComponent<TagComponent>())
		{
			...
			if (ImGui::InputText("##Tag", buffer, sizeof(buffer))) // ## to hide it
