...
namespace Hazel
{
	...
	struct Renderer2Ddata
	{
		...
		static const uint32_t MAX_TEXTURES_SLOT = 32; // TODO: RenderCaps
		...
		uint32_t TextureSlotIndex = 1; // white texture
	};
	...
	void Renderer2D::Init()
	{
		...
		int32_t samplers[s_Data.MAX_TEXTURES_SLOT];
		for (int32_t i = 0; i < s_Data.MAX_TEXTURES_SLOT; ++i)
			samplers[i] = i;

		s_Data.TextureShader = Shader::Create("assets/shaders/Texture.glsl");
		s_Data.TextureShader->Bind();
		s_Data.TextureShader->SetIntArray("u_Texture", samplers, s_Data.MAX_TEXTURES_SLOT);
	...
	/* 1 */ 	void Renderer2D::DrawRotatedQuad(const glm::vec2& position, const glm::vec2& size, float rotation, const glm::vec4& color)
	{
